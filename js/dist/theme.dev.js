...
$(document).ready(function () {
  if (document.querySelector('.lightbox1-container')) {
    document.querySelector('.lightbox1-container').innerHTML += '<div class="city-container taipei-city-container page-dummy">' + document.querySelector('.taipei-city-container').innerHTML + '</div>';
  }
...
function handleReservation() {
  ...
  setupNavButtons();
  taipeiCityContainer.addEventListener('transitionend', function () {
    if (page == 4) {
      page = 0;
      taipeiCityContainer.style.transition = 'none';
      taipeiCityContainer.style.marginLeft = page * -100.5 + '%';
